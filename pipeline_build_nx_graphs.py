...
NODE_FEATURES = ["cell_type", "center_coord", "biomarker_expression", "volume", "boundary_polygon", 'cell_id', 'is_padding', 'perimeter', 'area', 'mean_radius', 'compactness_circularity', 'fractality', 'concavity', 'elongation', 'overlap_index', 'sbro_orientation', 'wswo_orientation']
...
def main():
    ...
    func_args = [(segment_config, pretransform_networkx_config, network_features_config)
