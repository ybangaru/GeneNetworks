...
from helpers import NO_JOBS, logger, plotly_spatial_scatter_subgraph, ANNOTATION_DICT
...
class CellularGraphDataset(Dataset):
    ...
    def __init__(self,
        ...
        if cell_type_mapping is None or cell_type_freq is None:
            ...
            self.cell_type_mapping, self.cell_type_freq, self.cell_annotation_mapping = get_cell_type_metadata(nx_graph_files)
        else:
...
class SubgraphSampler(object):
    ...
    def get_new_segment(self):
        ...
        loader = InfDataLoader(self.dataset, batch_size=self.batch_size, sampler=sampler, num_workers=self.num_workers, multiprocessing_context=get_context('loky'))
