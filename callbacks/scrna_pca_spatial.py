...
from helpers import build_graph_from_cell_coords, assign_attributes
from .ann_data_store import ann_data, categorical_columns, numerical_columns

@callback(
    Output("spca_liverslice-dropdown", "options"),
    Output("spca_color-dropdown", "options"),
    Output("spca_x-segment-dropdown", "options"),
    Output("spca_y-segment-dropdown", "options"),
    Input("spca_plot-container", "children"),
    prevent_initial_call=False
)
def update_dropdown_options_pca_spatial(_):
...
@callback(
    Output("spca_plot-container", "figure"),
    Input("spca_load-button", "n_clicks"),
    # Input("ann-data-obs-store", "data"),
    State("spca_liverslice-dropdown", "value"),
    State("spca_color-dropdown", "value"),
    State("spca_x-segment-dropdown", "value"),
    State("spca_y-segment-dropdown", "value"),
    prevent_initial_call=True
)
def load_plots_pca_spatial(n_clicks, liverslice, color_choice, x_segment, y_segment):
